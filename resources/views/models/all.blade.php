...
<div class="container">
    ...
    <div class="models-header">
        <div class="header-left">
            <h1 class="page-title">Все 3D Модели</h1>
        ...
        <div class="models-content">
            ...
            <div class="empty-state">
                ...
                <p class="empty-description">
                    ...
                    @else
                        Будьте первым, кто добавит 3D модель!
                    @endif
                </p>
                @if(request()->hasAny(['search', 'categories', 'min_price', 'max_price']))
                ...
                @else
                    ...
                    @else
                        <a href="{{ route('login') }}" class="btn btn-primary btn-empty">
                            Войдите, чтобы добавить модель
                        </a>
                    @endauth
                @endif
            </div>
